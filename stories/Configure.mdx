  ...
  <div className="sb-section">
    <div className="sb-features-grid">
      <div className="sb-grid-item">
        <Image src={Docs} alt="A screenshot showing the autodocs tag being set, pointing a docs page being generated" />
      ...
      <div className="sb-grid-item">
        <Image src={Share} alt="A browser window showing a Storybook being published to a chromatic.com URL" />
      ...
      <div className="sb-grid-item">
        <Image src={FigmaPlugin} alt="Windows showing the Storybook plugin in Figma" />
      ...
      <div className="sb-grid-item">
        <Image src={Testing} alt="Screenshot of tests passing and failing" />
      ...
      <div className="sb-grid-item">
        <Image src={Accessibility} alt="Screenshot of accessibility tests passing and failing" />
      ...
      <div className="sb-grid-item">
        <Image src={Theming} alt="Screenshot of Storybook in light and dark mode" />
...
<div className='sb-addon'>
  ...
  <div className='sb-addon-img'>
    <Image src={AddonLibrary} alt="Integrate your tools with Storybook to connect workflows." />
  </div>
</div>

<div className="sb-section sb-socials">
    <div className="sb-section-item">
      <Image src={Github} alt="Github logo" className="sb-explore-image"/>
    ...
    <div className="sb-section-item">
      <Image src={Discord} alt="Discord logo" className="sb-explore-image"/>
      <div>
    ...
    <div className="sb-section-item">
      <Image src={Youtube} alt="Youtube logo" className="sb-explore-image"/>
      <div>
    ...
    <div className="sb-section-item">
      <Image src={Tutorials} alt="A book" className="sb-explore-image"/>
